          ...
          return postComment.push(
            <div className="modal-comment-content" key={comment.commentID}>
              ...
              <div className="modal-comment-wraper">
                ...
                <small className="modal-comment-comment">{comment.content}</small>
      ...
      <div className="modal" onClick={props.onClose}>
        ...
        <div className="modal-content-post" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="modal-side-info">
            ...
            <div className="modal-postmodal-header">
              ...
              <div className="delete-container">
                ...
                {
                  props.ownerID === loggedUser.id ?
                    (<DeleteOutlineRoundedIcon className="delete-img" onClick={() => handleDeletePost(props.postID)} />)
                    :
                    null
                }
